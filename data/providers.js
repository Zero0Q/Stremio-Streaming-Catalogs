export const providers = [
    ...
    { id: 'hst', name: 'Hotstar', language:'in', regions: { movie: 'IN', show: 'IN' } , default: false },
    { id: 'zee', name: 'Zee5',  language:'in', regions: { movie: 'IN', show: 'IN' } , default: false },
    { id: 'vil', name: 'Videoland',  language:'nl', regions: { movie: 'NL', show: 'NL' } , default: false },
    { id: 'blv', name: 'BluTV',  language:'tr', regions: { movie: 'TR', show: 'TR' } , default: false },
    { id: 'clv', name: 'Clarovideo',  language:'br', regions: { movie: 'BR', show: 'BR' } , default: false },
    { id: 'gop', name: 'Globoplay',  language:'br', regions: { movie: 'BR', show: 'BR' } , default: false },
    { id: 'hay', name: 'Hayu', regions: { show: 'GB' } , default: false },
    { id: 'nlz', name: 'NLZIET',  language:'nl', regions: { movie: 'NL', show: 'NL' } , default: false },
    { id: 'sst', name: 'SkyShowtime',  language:'nl', regions: { movie: 'NL', show: 'NL' } , default: false },
    ...
    { id: 'cpd', name: 'Canal+',  language:'fr', regions: { movie: 'FR', show: 'FR' } , default: false },
